			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-5">
						<p id="page-title" class="h1">Contato</p>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-7 col-lg-7 col-lg-offset-1">
							...
							<div class="alert alert-success" role="alert">
								...
								<strong>Sucesso!</strong> Sua mensagem foi enviada, aguarde nosso retorno.
							</div>
							<% end if %>
								...
								<form method="post" action="contato.asp" onsubmit="return validateform();">
									...
									<button class="custom-btn small dark-color" type="submit" data-text="Submit"><span>Enviar</span></button>
								</form>
							</div>
						</div>
					</div>
